...
basic_test(Config) ->
    ...
    miner_fake_radio_backplane:transmit(
        <<?JOIN_REQUEST:3, 0:5, 1337:64/integer-unsigned-big, 1234:64/integer-unsigned-big,
            1111:16/integer-unsigned-big, 0:32/integer-unsigned-big>>,
        911.200,
        631210968910285823
    ),
